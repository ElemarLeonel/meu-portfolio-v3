export default function EmptyState() {
  return (
    <section className="bg-blue-600 py-20 px-10 rounded-tl-[200px] rounded-br-[200px] mt-16 flex flex-col items-center justify-center">
      <svg
      ...
      >
        ...
        <path
          ...
          fill="#dab785"
        />
        <circle cx={190.15351} cy={24.95465} r={20} fill="#dab785" />
        ...
        <path
          ...
          fill="#dab785"
        />
        <circle cx={433.63626} cy={105.17383} r={20} fill="#dab785" />
